...
class Laporan extends CI_Controller{
	...
	function anggota(){
		...
		$this->template->load('template', 'laporan/anggota', $data);
	}
	...
	function buku(){
		...
		$this->template->load('template', 'laporan/buku', $data);
	}

	function peminjaman(){
		$data['title']		= "Laporan Peminjaman";
		// $this->template->display('laporan/peminjaman', $data);
		$this->template->load('template', 'laporan/peminjaman', $data);
	}
	...
	function detail_pinjam($id){
		$data['title']		= $id;
		$data['pinjam']		= $this->m_laporan->detail_pinjam($id)->result();
		// $this->template->display('laporan/detail_pinjam', $data);
		$this->template->load('template', 'laporan/detail_pinjam', $data);
	}

	function pengembalian(){
		$data['title']		= "Detail Pengembalian";
		// $this->template->display('laporan/pengembalian', $data);
		$this->template->load('template', 'laporan/pengembalian', $data);
	}
