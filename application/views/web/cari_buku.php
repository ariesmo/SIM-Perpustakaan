			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li class="active"><a href="<?= site_url('web');?>"><i class="glyphicon glyphicon-home"></i>Home</a></li>
						<li><a href="<?= site_url('web/anggota');?>"><i class="glyphicon glyphicon-user"></i>Anggota</a></li>
					</ul>
					<div class="nav navbar-nav navbar-right">
						<form class="navbar-form navbar-left" role="search" action="<?= site_url('web/cari_buku');?>" method="post">
				...
				<div class="col-md-8">
					...
					<table class="table table-stripped">
						...
						<?php $no=0; foreach($hasil as $row) : $no++;?>
							<tr>
								<td><?= $no;?></td>
								<td><img src="</= base_url('assets/img/'.$row->image);?>" width="100px" height="100px"></td>
								<td><?= $row->kode_buku;?></td>
								<td><?= $row->judul;?></td>
								<td><?= $row->pengarang;?></td>
