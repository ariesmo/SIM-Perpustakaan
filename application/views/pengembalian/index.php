	...
	$(function(){
		...
		var keycode = (event.keyCode ? event.keyCode : event.which);
			...
			if(keycode == '13'){
				...
				$.ajax({
					url: "<?= site_url('pengembalian/cariTransaksi');?>",
					type: "POST",
					data: "no="+no,
					cache: false,
					success:function(msg){
						if(msg==""){
							...
							$("#denda").focus();
							$("#tampil").load("<?= site_url('pengembalian/tampil');?>","no="+no);
						}
					}
				})
			}
		...
		$("#simpan").click(function(){
			...
			if(no=="" || nis==""){
				...
				if(nominal==""){
					...
					$.ajax({
						url: "<?= site_url('pengembalian/simpan');?>",
						type: "POST",
		...
		$("#carinis").keyup(function(){
			...
			$.ajax({
				url: "<?= site_url('pengembalian/cari_by_nis');?>",
				type: "POST",
				data: "nis="+nis,
				cache: false,
				success:function(html){
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-horizontal">
					<label class="col-lg-3 control-label">Cari Nis Peminjam</label>
					<div class="col-lg-5">
